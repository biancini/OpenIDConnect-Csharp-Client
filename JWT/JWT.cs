    ...
    public static class JsonWebToken
    {
        ...
        static JsonWebToken()
        {
            HashAlgorithms = new Dictionary<JwtHashAlgorithm, Func<byte[], byte[], byte[]>>
            {
                ...
                { JwtHashAlgorithm.RS256, (key, value) => { using (var sha = new SHA256Managed()) { return sha.ComputeHash(value); } } },
                { JwtHashAlgorithm.RS512, (key, value) => { using (var sha = new SHA512Managed()) { return sha.ComputeHash(value); } } },
                { JwtHashAlgorithm.RS384, (key, value) => { using (var sha = new SHA384Managed()) { return sha.ComputeHash(value); } } },
            };
        }
        ...
        private static JwtHashAlgorithm GetHashAlgorithm(string algorithm)
        {
            switch (algorithm)
            {
                ...
                case "RS384": return JwtHashAlgorithm.HS384;
                case "RS512": return JwtHashAlgorithm.HS512;
